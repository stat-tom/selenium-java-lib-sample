...
public class ProfilZaufanyTest extends BaseTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ProfilZaufanyTest.class);
...
//    @Test(priority = 1)
//    void setup() {
//        String driverPath = "D:\\sample-selenium-project\\src\\test\\resources\\chromedriver.exe";
...
//    }
    ...
    void clickOnEUrzad() {
        ...
        loginGovPlBtn.click();
        WebElement profilZaufanyBtn = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//ul[@class='gov2-login__list']/li[1]")));
        logger.info("element: {}", profilZaufanyBtn);
        Assert.assertNotNull(profilZaufanyBtn, "Element not found!");
        profilZaufanyBtn.click();
        WebElement profilZaufanyLoginBtn = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("loginForm:loginButton")));
        logger.info("element: {}", profilZaufanyLoginBtn);
        Assert.assertNotNull(profilZaufanyLoginBtn, "Element not found!");
    }
